...
Route::get('komoditasdetail', 'KategoriKomoditasDetailController@index')->name('komoditasdetail.index');
Route::post('komoditasdetail', 'KategoriKomoditasDetailController@store')->name('kategorikomoditasdetail.store');
Route::get('kategorikomoditasdetail/{id}', 'KategoriKomoditasDetailController@destroy')->name('kategorikomoditasdetail.destroy');
