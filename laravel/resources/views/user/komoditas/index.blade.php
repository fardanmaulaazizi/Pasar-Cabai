...
@section('content')
    <section class="content">
        <div class="container-fluid">
            @if (session('alert'))
                <div class="row alert alert-success alert-dismissible fade show"style="margin: 0 0 20px 0" role="alert">
                    {{ Session::get('alert') }}
            ...
            @switch(Auth::user()->role_id)
                @case(1)
                    ...
                    {{-- Modal Terjual --}}
                    <div class="modal fade" id="modalJual" tabindex="-1" role="dialog" aria-labelledby="modalJual"
                        aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered" role="document">
                            <div class="modal-content">
                                            ...
                                            <div class="col-lg-12">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        <input class="form-control" type="number" id="max_terjual" name="terjual"
                                                            placeholder="Terjual">
                ...
                @case(2)
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-12">
                                <div class="card" style="background-color: #f7941d">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="radio" name="seragam"
                                                            id="seragam98" value="98">
                                            ...
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="radio" name="panjang"
                                                            id="panjang12" value="12">
                                            ...
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="radio" name="pangkal"
                                                            id="pangkal3" value="1.4">
                                            ...
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="radio" name="kotor"
                                                            id="kotor1" value="1">
                                            ...
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    <label class="col-form-label" for="busuk">Tingkat kerusakan dan
                                                        busuk</label>
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="radio" name="busuk"
                                                            value="0" id="busuk0">
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-12">
                                <div class="card card-info">
                                    <div class="card-header" style="background-color: #f7941d">
                                        <h3 class="card-title">List Komoditas Tani Cabai
                ...
                $(document).ready(function() {
                    var tabel_komoditas = $("#tabel_komoditas").DataTable({
                        ...
                        columns: [{
                            ...
                            {
                                data: 'kategori_komoditas_detail.keterangan',
                                name: 'kategori_komoditas_detail.keterangan'
                            },
                            {
                                data: 'telah_terjual',
                                name: 'telah_terjual'
                    ...
                    $('body').on('click', '.hapus', function() {
                        ...
                        $.ajax({
                            ...
                            success: function(response) {
                                $('#kategori').text("Apakah anda yakin menghapus " + response
                                    .kategori_komoditas_detail.keterangan + " dengan kuantitas " +
                                    response.kuantitas + " Kilogram");
                    ...
                    $('body').on('click', '.jual', function() {
                        ...
                        $.ajax({
                            ...
                            type: "GET",
                            success: function(response) {
                                $('#keterangan_komoditas').text("Komoditas " + response
                                    .kategori_komoditas_detail.keterangan + " dengan kuantitas " +
                                    response.kuantitas + " Kilogram telah terjual");
                                $('#kuantitas').text(response.kuantitas + " Kg");
                                $('#max_terjual').attr({
                ...
                $(document).ready(function() {
                    var tabel_komoditas = $("#tabel_komoditas").DataTable({
                        ...
                        columns: [{
                            ...
                            {
                                data: 'kuantitas_tersisa',
                                name: 'kuantitas_tersisa',
