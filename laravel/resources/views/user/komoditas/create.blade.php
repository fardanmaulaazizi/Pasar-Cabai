                            ...
                            <div class="card-body">
                                            ...
                                            <select name="kategori" id="kategori" class="form-control"
                                                ...
                                                @foreach ($kategori as $item)
                                                    <option value="{{ $item->id }}"
                                                        @if (old('kategori') == $item->id) selected @endif>
                                                    ...
                                                    $.ajax({
                                                        ...
                                                        success: function(response) {
                                                            ...
                                                            response.forEach(element => {
                                                                $('#detail_kategori').append(
                                                                    `<option value="${element['id']}">${element['keterangan']}</option>`
                                                                    );
                                                            });
                                                        }
                                                    })
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <div class="input-group">
                                            <input type="number" name="harga_minimal" class="form-control"
                                                id="harga_minimal" placeholder="Harga Minimal Perkilogram">
                                            <div class="input-group-append">
                                                <span class="input-group-text">/Kg</span>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="input-group">
                                            <input type="number" name="harga_maksimal" class="form-control"
                                                id="harga_maksimal" placeholder="Harga Maksimal Perkilogram">
                                            <div class="input-group-append">
                                                <span class="input-group-text">/Kg</span>
                                            </div>
                                        </div>
