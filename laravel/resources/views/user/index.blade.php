                    ...
                    <div class="row">
                        <div class="col-lg-5 col-6">
                            ...
                            <div class="small-box bg-info">
                                ...
                                <a href="{{ route('komoditas.index') }}" id="url_komoditas_index" class="small-box-footer">Info
                                    Selanjutnya <i class="fas fa-arrow-circle-right"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-6">
                            ...
                            <div class="small-box bg-info">
                                ...
                                <a href="{{ route('gudang.index') }}" id="url_gudang_index" class="small-box-footer">Info
                                    Selanjutnya <i class="fas fa-arrow-circle-right"></i></a>
                            </div>
                        </div>
                        <!-- ./col -->
