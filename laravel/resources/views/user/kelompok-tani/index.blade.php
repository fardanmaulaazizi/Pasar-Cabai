    ...
    <section class="content">
        <div class="container-fluid">
            @if (Session::has('alert'))
                <div class="row alert alert-success alert-dismissible fade show" role="alert" style="margin:5px">
                    {{ Session::get('alert') }}
                                            ...
                                            <div class="col-lg-12">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" type="text" id="keterangan" name="keterangan"
                                                        placeholder="Nama Kelompok Petani" required>
                                                    <label class="col-form-label" for="keterangan">Desa</label>
            ...
            var tabel_kelompok_tani = $("#tabel_kelompok_tani").DataTable({
                ...
                columns: [{
                    ...
                    },
                    {
                        ...
                        name: 'desa.kecamatan.nama_kecamatan'
                    },
                    {
                        data: 'action',
                        name: 'action',
