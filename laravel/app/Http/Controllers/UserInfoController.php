    ...
    public function jsonPetani()
    {
        return DataTables::of(UserInfo::with('user', 'desa.kecamatan', 'kelompok_tani')->where('desa_id', Auth::user()->user_gudang->desa_id))
            ...
            ->addColumn('action', function ($row) {
                ...
                $action = '
                    <a class="btn btn-info" href="petani/' . $id . '">Detail</a>
                ';
                return $action;
            })
                ...
                return DataTables::of(Komoditas::where('user_info_id', $id)->with('kategori_komoditas_detail')->get())
                    ...
                    ->addColumn('status_pengajuan', function ($row) {
                        switch ($row->status_pengajuan) {
                            case 1:
                                $action = '<a class="btn btn-xs btn-secondary" href="#" style="width:120px">Belum diperiksa</a>';
                                break;
                            case 2:
                                $action = '<a class="btn btn-xs btn-warning" href="#" style="width:120px">Menunggu</a>';
                                break;
                            case 3:
                                $action = '<a class="btn btn-xs btn-success" href="#" style="width:120px">Disetujui</a>';
                                break;

                            default:
                                $action = '<a class="btn btn-xs btn-danger" href="#" style="width:120px">Undefined</a>';
                                break;
                        }
                    ...
                    ->addColumn('status_uji_kualitas', function ($row) {
                        switch ($row->status_uji_kualitas) {
                            case 1:
                                $action = '<a class="btn btn-xs btn-secondary" style="width:120px" href="#">Belum diperiksa</a>';
                                break;
                            case 2:
                                $action = '<a class="btn btn-xs btn-info" style="width:120px" href="#">Disetujui</a>';
                                break;

                            default:
                                $action = '<a class="btn btn-xs btn-danger" style="width:120px" href="#">Undefined</a>';
                                break;
                        }
                    ...
                    ->addColumn('action', function ($row) {
                        ...
                        if ($row->status_pengajuan == 1) {
                            $action = '
                                <a class="btn btn-info" href="' . $detailKomoditasUrl . '">Detail</a>
                            ';
