                ...
                return DataTables::of(Komoditas::where('user_info_id', $user_info_id)->with('kategori_komoditas_detail', 'verifikasi_kualitas')->where('status', true)->get())
                    ...
                    ->addColumn('status_pengajuan', function ($row) {
                        switch ($row->status_pengajuan) {
                            case 1:
                                $action = '<div class="btn btn-xs btn-secondary">Belum diperiksa</div>';
                                break;
                            case 2:
                                $action = '<div class="btn btn-xs btn-warning">Ditolak</div>';
                                break;
                            case 3:
                                $action = '<div class="btn btn-xs btn-success">Disetujui</div>';
                                break;

                            default:
                                $action = '<div class="btn btn-xs btn-danger">Undefined</div>';
                                break;
                        }
                    ...
                    ->addColumn('telah_terjual', function ($row) {
                        $action = '
                            Awal :<br><a class="btn btn-xs btn-info" >' . $row->kuantitas . '</a>
                            <br>
                            Terjual :<br><a class="btn btn-xs btn-danger">' . $row->terjual . '</a>
                        ';
                    ...
                    ->addColumn('mutu', function ($row) {
                        if (isset($row->verifikasi_kualitas)) {
                            $action = '
                                <div class="btn btn-xs btn-info">' . $row->verifikasi_kualitas->mutu . '</div>
                            ';
                        } else {
                            $action = '
                                <div class="btn btn-xs btn-warning">Belum diuji</div>
                            ';
                        }
                        return $action;
                    })
                    ->addColumn('status_uji_kualitas', function ($row) {
                        switch ($row->status_uji_kualitas) {
                            case 1:
                                $action = '<div class="btn btn-xs btn-secondary" href="#">Belum diperiksa</div>';
                                break;
                            case 2:
                                $action = '
                                    <div class="btn btn-xs btn-successx" href="#">Disetujui</div>
                                    <div class="btn btn-xs btn-secondary" href="#">' . $row->verifikasi_kualitas->mutu . '</div>
                                ';
                                break;

                            default:
                                $action = '<div class="btn btn-xs btn-danger" href="#">Undefined</div>';
                                break;
                        }
                    ...
                    ->addColumn('action', function ($row) {
                        ...
                        if ($row->status_pengajuan == 1) {
                            $action = '
                                <a class="btn btn-info mb-1" style="width:90px" href="' . $detailKomoditasUrl . '">Detail</a>
                                <a class="btn btn-danger hapus" style="width:90px" id="' . $id . '">Hapus</a>
                            ';
                        } elseif ($row->status_pengajuan == 2) {
                            $action = '
                                <a class="btn btn-info mb-1" style="width:90px" href="komoditas/' . $id . '">Detail</a>
                                <a class="btn btn-danger hapus" style="width:90px" id="' . $id . '">Hapus</a>
                            ';
                            ...
                            if ($row->status_uji_kualitas == 2) {
                                if ($row->terjual == $row->kuantitas) {
                                    $action = '
                                        <a class="btn btn-info" style="width:90px" href="' . $detailKomoditasUrl . '">Detail</a>
                                    ';
                                } else {
                                    $action = '
                                        <a class="btn btn-info mb-1" style="width:90px" href="' . $detailKomoditasUrl . '">Detail</a>
                                        <a class="btn btn-success jual" style="width:90px" id="' . $id . '">Terjual</a>
                                    ';
                                }
                            } else {
                                $action = '
            ...
            case 3:                         //PENGELOLA GUDANG
                return DataTables::of(Komoditas::with('kategori_komoditas_detail', 'user_info')->where('desa_id', Auth::user()->user_gudang->desa_id)->where('status', true))
                    ...
                    ->addColumn('action', function ($row) {
                        ...
                        if ($row->status_pengajuan == 1) {
                            $action = '
                                <a class="btn btn-info" style="width:90px" href="komoditas/' . $id . '">Detail</a>
                            ';
                        } elseif ($row->status_pengajuan == 2) {
                            $action = '
                                <a class="btn btn-secondary" style="width:90px" href="komoditas/' . $id . '">Detail</a>
                            ';
                        } elseif ($row->status_pengajuan == 3) {
                            if ($row->status_uji_kualitas == 2) {
                                $action = '
                            ...
                            $action = '
                                <a class="btn btn-danger hapus" id="' . $id . '>Hapus</a>
                            ';
                        }
                    ...
                    ->addColumn('telah_terjual', function ($row) {
                        $action = '
                            Awal :<br><a class="btn btn-xs btn-info" style="width:65px">' . $row->kuantitas . '</a>
                            <br>
                            Terjual :<br><a class="btn btn-xs btn-danger" style="width:65px">' . $row->terjual . '</a>
                        ';
                    ...
                    ->addColumn('mutu', function ($row) {
                        if (isset($row->verifikasi_kualitas)) {
                            $action = '
                                <a class="btn btn-xs btn-info" style="width:60px">' . $row->verifikasi_kualitas->mutu . '</a>
                            ';
                        } else {
                            $action = '
                                <a class="btn btn-xs btn-warning" style="width:60px">Belum diuji</a>
                            ';
                        }
                        return $action;
                    })
                    ->addColumn('status_komoditas', function ($row) {
                        if ($row->status_pengajuan == 1) {
                            $action = '
                                <a class="btn btn-xs btn-info" style="width:70px">Belum diperiksa</a>
                            ';
                        } elseif ($row->status_pengajuan == 2) {
                            $action = '
                            <a class="btn btn-xs btn-warnign" style="width:70px" >Ditolak</a>
                            ';
                        } elseif ($row->status_pengajuan == 3) {
                            $action = '
                                <a class="btn btn-xs btn-success" style="width:70px">Disetujui</a>
                            ';
                        } else {
                            $action = '
                                <a class="btn btn-xs btn-danger" style="width:70px">Unidentified</a>
                            ';
                        }
                        return $action;
                    })
